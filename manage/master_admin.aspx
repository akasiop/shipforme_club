<%@ Page Language="C#" AutoEventWireup="true" CodeFile="master_admin.aspx.cs" Inherits="club_manage_master_admin" %>
			...
			<div class="breadcrumbs">
				<div class="container">
					<div class="breadcrumbs-left">
						<h1><asp:Label ID="lblMessage1" runat="server" ForeColor="#EC005F" Text=""></asp:Label></h1>
					</div>
				...
				<div class="container">
					<div class="blog-left">
						<div class="blog-left-head">
							<span> </span>
							<h3>您好！<asp:Label ID="lblMessage2" runat="server"  Text=""></asp:Label>
                                <asp:Label ID="lblMessage3" runat="server" ForeColor="#EC005F" Text=""></asp:Label>
							</h3>
						</div>
					...
					<div class="blog-right">
						...
						<!----start-accordinatio-files--->
							...
							<div class="accordion-content" style="width: 242px;">
								<ul>
									<li><a href="update_intro.aspx" target="Right">修改简介</a></li>
									<li><a href="update_leader.aspx" target="Right">更新组织结构</a></li>
                                    <li><a href="update_mem.aspx" target="Right">管理社员信息</a></li>
                                    <li><a href="activity_apply.aspx" target="Right">社团活动上报</a></li>
                                     <li><a href="update_activity.aspx" target="Right">社团活动管理</a></li>
                                    <li><a href="write_news.aspx" target="Right">更新社团动态</a></li>
                                    <li><a href="attend_upload.aspx" target="Right">管理基本考勤</a></li>
								</ul>
							</div>
